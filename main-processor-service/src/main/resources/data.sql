...
insert into products_info(id, product_id, supplier_id, price, available_amount)
...
LOCK TABLE products, carts, suppliers, products_info IN ACCESS EXCLUSIVE MODE;
...
SELECT setval('products_info_id_seq', COALESCE((SELECT MAX(id) + 1 FROM products_info), 1), false);
